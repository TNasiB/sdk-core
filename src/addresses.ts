...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.SEPOLIA]: '0x6f7E31727d0FCCFFc534160BE93DEcADaAeE6423',
  [ChainId.ATLETA_OLYMPIA]: '0x05A95dc00151562009dBf41406E99f1039F9da4B',
...
// arbitrum sepolia v3 addresses (invalid)
const ARBITRUM_SEPOLIA_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x4395d744fA3D985fA78A4e20183D79aCaB7F8F00',
  multicallAddress: '0x0490d65E42388DF4E388d5E801Ba59f463eAE98E',
  quoterAddress: '0x8a58Ba91530335D2f3A2A9dDDFb00DD4D1b7DB49',
  v3MigratorAddress: '0x5Dab59C8e50eB362D6DB4A1F0AC1E8736BB32974',
  nonfungiblePositionManagerAddress: '0x87b6C46716fE1B008ea7822EE11d9cC42ea05f58',
  tickLensAddress: '0xB0143315F89814B7Af2763BD09070618EBc0B078',
  swapRouter02Address: '0xabA86e02f7a8ecE308ac962e16D4928072A7773d'
}
...
const SEPOLIA_ADDRESSES: ChainAddresses = {
  ...
  nonfungiblePositionManagerAddress: '0x87b6C46716fE1B008ea7822EE11d9cC42ea05f58',
  tickLensAddress: '0xB0143315F89814B7Af2763BD09070618EBc0B078',
  swapRouter02Address: '0xE227f11892BBe546A6DC05Ab6FaF3406b20a81d8'
}

const ATLETA_OLYMPIA_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x3A2d3E0DBa6ddB1401b52c48cd930a2AB4CF7B84',
  multicallAddress: '0xd833F12b94C97b738C22B18bCD97E96016934189',
  quoterAddress: '0x899Da3C2C4F3cE7e422d131Cc15103ff6240dA54',
  v3MigratorAddress: '0xe6912F944a6c63c5c1a14A2A8F10279C3759A911',
  nonfungiblePositionManagerAddress: '0xe3D88408dBf5F0a370aA0C5d2E1469fd7ee33311',
  tickLensAddress: '0x9a69D5f1C9EFfa10FfE3Da1E78407004FB6C1DFB',
  swapRouter02Address: '0x5687AEcDB1b756C4064357f751E415DE768EcAE4'
}
...
export const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  ...
  [ChainId.ATLETA_OLYMPIA]: ATLETA_OLYMPIA_ADDRESSES
}
